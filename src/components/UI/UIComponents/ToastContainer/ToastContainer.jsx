...
const ToastContainer = ({ type = 0, message = "Hello World", duration = 1000, onClose, showToast }) => {
    ...
    return createPortal(
        ...
        >
            <div style={isHover ? {animationPlayState: "paused"} : {animationPlayState: "running"}} onAnimationEnd={onClose} className={`h-2 rounded-t-lg animateToast ${getProgressBarColor(type)}`} ></div>
